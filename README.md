# 🎨 AI Manager Prompter
✨ 可爱又强大的AI绘画标签提词器，让你的创作灵感一键爆发！

<p align="center">
  <img src="https://img.shields.io/badge/vue->=3.2.13-ff69b4.svg" alt="vue">
  <img src="https://img.shields.io/badge/elementplus->=2.3.1-6bb59a.svg" alt="element-plus">
...
- 🌍 **中文友好**：全中文界面，操作无压力
- ⚖️ **权重调节**：支持标签加权、降权，精准控制生成效果
- 🎨 **丰富标签**：涵盖人物、动作、场景、风格等多种类别
- 🔄 **实时预览**：即时查看生成的提示词效果
- 📋 **一键复制**：生成的提示词可直接复制使用
- 🎁 **完全免费**：终身开源，禁止商用
